...
Create comprehensive unit tests for the current code and generate the test file
with proper imports and setup according to the project's testing conventions.
...
2. **Test Structure**
   - try to located all tests under **tests** directory
