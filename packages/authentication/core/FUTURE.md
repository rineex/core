# Future Work — Aspirational Auth Design

> Preserved from the original Definition.md. This describes target-state
> features not yet implemented. See Definition.md for what exists today.
